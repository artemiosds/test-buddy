  ...
  profissional: {
    ...
    map: {
      ...
      licenca_saude: {
        ...
        icon: FileText,
        colorToken: "info",
        description: "Licença para tratamento de saúde.",
      },
      licenca_luto: {
        label: "Licença Luto",
        variant: "secondary",
        ...
        icon: FileText,
        colorToken: "info",
        description: "Licença por falecimento (nojo).",
      },
      licenca_sem_vencimento: {
        ...
        icon: FileText,
        colorToken: "warning",
        description: "Licença sem remuneração.",
      },
      licenca_estudo: {
        label: "Licença Estudo",
        variant: "secondary",
        className: "bg-info-soft text-info-soft-foreground",
        icon: FileText,
        colorToken: "info",
        description: "Licença para estudo/capacitação.",
      },
      atestado: {
        label: "Atestado",
        variant: "secondary",
        ...
        icon: FileText,
        colorToken: "warning",
        description: "Ausência coberta por atestado médico.",
      },
      afastamento_inss: {
        label: "Afastamento por INSS",
        variant: "secondary",
        className: "bg-warning-soft text-warning-soft-foreground",
        icon: UserMinus,
        colorToken: "warning",
