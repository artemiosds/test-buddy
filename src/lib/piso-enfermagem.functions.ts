...
const LinhaSchema = z.object({
  ...
  dias_trabalhados: z.number().nullable().optional(),
  iss: z.number().nullable().optional(),
  total_liquido_base: z.number().nullable().optional(),
  gratificacao_incentivo: z.number().nullable().optional(),
  auxilio_transporte: z.number().nullable().optional(),
  incentivo: z.number().nullable().optional(),
        ...
        filtraCampos(
          {
            ...
            iss: l.iss ?? null,
            total_liquido_base: l.total_liquido_base ?? null,
            gratificacao_incentivo: l.gratificacao_incentivo ?? null,
            auxilio_transporte: l.auxilio_transporte ?? null,
            incentivo: l.incentivo ?? l.auxilio_financeiro ?? null,
            plantao: l.plantao ?? null,
            sobreaviso: l.sobreaviso ?? null,
