...
export const CATALOG: BlockDef[] = [
  ...
  /* ===== Cadastro Geral ===== */
  {
    ...
    fields: [
      ...
      { id: "salario_base", label: "Salário Base", tipo: "number" },
      { id: "salario_bruto", label: "Salário Bruto", tipo: "number" },
      { id: "salario_liquido", label: "Salário Líquido", tipo: "number" },
      { id: "horas_extras", label: "Horas Extras", tipo: "number" },
      { id: "adicional_noturno", label: "Adic. Noturno", tipo: "number" },
      { id: "gratificacao_incentivo", label: "Gratif. Inc.", tipo: "number" },
      { id: "vencimento_liquido", label: "Venc. Líquido", tipo: "number" },
    ],
