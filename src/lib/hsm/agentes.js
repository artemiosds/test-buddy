...
export const HSM_AGENTES = [
    ...
    },
    {
        ...
        instrucao: "Você é o agente de Gestão de Pessoas. Priorize dados funcionais: cadastro, cargo, função, vínculo, lotação e situação do profissional. Sempre destaque inconsistências cadastrais que encontrar.",
        sugestoes: [
    ...
    },
    {
        ...
        instrucao: "Você é o agente de Frequência. Foque em competências, prazos, status de envio e aprovação das folhas. Aponte unidades atrasadas.",
        sugestoes: [
    ...
    },
    {
        ...
        instrucao: "Você é o agente do Piso Nacional da Enfermagem. Foque em elegíveis, categorias de enfermagem, competências e consolidação da folha. Nunca cite valores de referência que não tenham vindo de uma ferramenta.",
        sugestoes: [
    ...
    },
    {
        ...
        instrucao: "Você é o agente de Pendências. Priorize prazos, prioridade e SLA. Ordene sempre da mais crítica para a menos crítica.",
        sugestoes: [
    ...
    },
    {
        ...
        instrucao: "Você é o agente da Rede Assistencial. Foque em unidades, setores, CNES e estrutura organizacional.",
    ...
    },
    {
        ...
        instrucao: "Você é o agente Gerencial. Priorize números consolidados, comparações e tendências. Sempre apresente os dados em tabela e destaque o indicador mais relevante.",
        sugestoes: [
    ...
    },
    {
        ...
        instrucao: "Você é o agente de Auditoria. Foque em rastreabilidade: quem fez, o quê e quando. Seja rigoroso e nunca especule sobre intenção.",
        sugestoes: [
...
export function agentePorSlug(slug) {
...
export function agentesDisponiveis(habilitados) {
