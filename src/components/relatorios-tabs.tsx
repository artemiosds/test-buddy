    ...
    <div className="space-y-2">
      <div>
        <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
          Operacionais <span className="font-normal normal-case text-muted-foreground/70">(por competência)</span>
        </div>
        <Row tabs={OPERACIONAIS} activeGroup={!isGerencial} currentPath={pathname} />
      </div>
      <div>
        <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
          Gerenciais <span className="font-normal normal-case text-muted-foreground/70">(cadastros atuais)</span>
        </div>
