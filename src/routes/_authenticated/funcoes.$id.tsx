    ...
    <div className="space-y-6 p-4 md:p-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link to="/cargos-funcoes" hash="funcoes">
                Funções
              </Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <PageHeader
        ...
        description={
          [
            ...
            metaQ.data?.gratificacao_percentual != null &&
              `Gratificação ${metaQ.data.gratificacao_percentual}%`,
          ]
            .filter(Boolean)
            .join(" · ") || "Painel da função"
        }
        actions={
      ...
      <section className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <KpiCard
          label="Unidades"
          value={porUnidade.length.toLocaleString("pt-BR")}
          loading={a.distribuicaoUnidade.isLoading}
          icon={<Building2 className="h-4 w-4" />}
        />
        <KpiCard
          label="Setores"
          value={porSetor.length.toLocaleString("pt-BR")}
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Profissionais por Unidade</CardTitle>
          </CardHeader>
          <CardContent>
            <DataTable
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Profissionais por Setor</CardTitle>
          </CardHeader>
          <CardContent>
            <DataTable
