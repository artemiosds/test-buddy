...
function RelatoriosPage() {
    ...
    async function certificar(rows) {
    ...
    return (<div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <Button variant="outline" className="w-full sm:w-auto" onClick={() => void exportarCSV()} disabled={!canExport || !linhas.length}>
            <Download className="mr-2 h-4 w-4"/> CSV
          </Button>
          <Button className="w-full sm:w-auto" onClick={() => void exportarXLSX()} disabled={!canExport || !linhas.length}>
        ...
        <div>
          ...
          <Select value={competenciaId} onValueChange={setCompetenciaId}>
            ...
            <SelectContent>
              ...
              {competencias?.map((c) => (<SelectItem key={c.id} value={c.id}>
        ...
        <div>
          ...
          <Select value={unidadeId} onValueChange={setUnidadeId}>
            ...
            <SelectContent>
              ...
              {unidades?.map((u) => (<SelectItem key={u.id} value={u.id}>
                  {u.sigla ? `${u.sigla} — ` : ""}
                  {u.nome}
                </SelectItem>))}
            </SelectContent>
      ...
      <ComplianceRiscosPanel competenciaId={competenciaId} unidadeId={unidadeId} nivel={nivel} enabled={canView}/>
