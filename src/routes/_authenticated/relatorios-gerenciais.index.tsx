...
const CARDS: Card[] = [
  ...
  {
    to: "/_authenticated/relatorios-gerenciais/auditoria",
    title: "Auditoria",
    desc: "Quem alterou cadastro, unidade, setor, cargo, função, usuário, importou/recalculou piso, excluiu.",
    icon: ShieldCheck,
  },
  {
    to: "/_authenticated/relatorios-gerenciais/salarios",
