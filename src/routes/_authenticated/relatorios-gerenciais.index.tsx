...
import { Users, Building2, Network, Briefcase, Tag, GitBranch, BarChart3, Coins, ShieldCheck } from "lucide-react";
...
const CARDS: Card[] = [
  ...
  { to: "/relatorios-gerenciais/estrutura", title: "Estrutura Organizacional", desc: "Organograma Diretor → Coordenador → Profissionais. Responsáveis por unidade e setor.", icon: GitBranch },
